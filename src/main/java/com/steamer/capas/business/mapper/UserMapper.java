...
public interface UserMapper {
    ...
    @Mapping(target = "carritoGames", source = "carritoGames")
    @Mapping(target = "cartera", source = "cartera")
    ...
    @Mapping(target = "carritoGames", source = "user.carritoGames")
    @Mapping(target = "cartera", source = "user.cartera")
